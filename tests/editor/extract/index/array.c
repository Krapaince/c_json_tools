     ...
     test_json_array_extract_bool_by_index_out_of_bounds)
{
    ...
    cr_expect(json_array_extract_bool_by_index(array, 45, &value) == JSON_EF);
...
Test(json_array_extract_bool_by_index, test_json_array_extract_bool_by_index)
{
    ...
    cr_expect(json_array_extract_bool_by_index(array, 0, &value) == JSON_ES);
    cr_expect(value == true);
    cr_expect(json_array_extract_bool_by_index(array, 0, &value) == JSON_EF);
    tests_json_array_destroy(array);
}
...
Test(json_array_extract_nb_by_index, test_json_array_extract_nb_by_index)
{
    ...
    cr_expect(json_array_extract_nb_by_index(array, 1, &value) == JSON_ES);
    cr_expect(value == 34);
    cr_expect(json_array_extract_nb_by_index(array, 1, &value) == JSON_EF);
    tests_json_array_destroy(array);
}
     ...
     test_json_array_extract_string_by_index)
{
    ...
    cr_expect(json_array_extract_string_by_index(array, 2, &value) == JSON_ES);
    cr_expect_str_eq(value, "toto");
    cr_expect(json_array_extract_string_by_index(array, 2, &value) == JSON_EF);
    free(value);
    tests_json_array_destroy(array);
}
...
Test(json_array_extract_str_by_index, test_json_array_extract_string_by_index)
{
    ...
    cr_expect(json_array_extract_str_by_index(array, 2, &value) == JSON_ES);
    cr_expect_str_eq(value.value, "toto");
    cr_expect(json_array_extract_str_by_index(array, 2, &value) == JSON_EF);
    free(value.value);
    tests_json_array_destroy(array);
}
     ...
     test_json_array_extract_object_by_index)
{
    ...
    cr_expect(json_array_extract_object_by_index(array, 4, &value) == JSON_ES);
    cr_expect(json_object_compare(value, expected));
    cr_expect(json_array_extract_object_by_index(array, 4, &value) == JSON_EF);
...
Test(json_array_extract_array_by_index, test_json_array_extract_object_by_index)
{
    ...
    cr_assert(expected != NULL);
    cr_expect(json_array_extract_array_by_index(array, 5, &value) == JSON_ES);
    cr_expect(json_array_compare(value, expected));
    cr_expect(json_array_extract_array_by_index(array, 5, &value) == JSON_EF);
