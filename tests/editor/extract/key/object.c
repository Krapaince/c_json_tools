...
Test(json_object_extract_nb_by_key, tests_json_object_extract_nb_by_key)
{
    ...
    cr_expect(json_object_extract_nb_by_key(object, "nb", &value) == JSON_ES);
    cr_expect(value == 34);
    cr_expect(json_object_extract_nb_by_key(object, "nb", &value) == JSON_EF);
    tests_json_destroy_object(object);
}
...
Test(json_object_extract_str_by_key, tests_json_object_extract_str_by_key)
{
    ...
    cr_expect(json_object_extract_str_by_key(object, "str", &value) == JSON_ES);
    cr_expect_str_eq(value.value, "toto");
    cr_expect(json_object_extract_str_by_key(object, "str", &value) == JSON_EF);
    free(value.value);
    tests_json_destroy_object(object);
}
