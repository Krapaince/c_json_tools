...
** json library
** File description:
** tests editor unset index array
*/
     ...
     test_json_object_unset_element_index_valid)
{
    ...
    cr_assert(json_object_append_bool(object, "toto", true) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_nb(object, "titi", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_str_dup(object, "tutu", "titi") ==
              JSON_EXIT_SUCCESS);
    cr_expect(json_object_unset_element_by_index(object, 1) == 1);
    cr_assert(expected != NULL);
    cr_assert(json_object_append_bool(expected, "toto", true) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_str_dup(expected, "tutu", "titi") ==
              JSON_EXIT_SUCCESS);
     ...
     test_json_object_unset_element_index_invalid)
{
    ...
    cr_assert(object != NULL);
    cr_assert(json_object_append_bool(object, "titi", true) ==
              JSON_EXIT_SUCCESS);
