...
Test(json_object_get_bool_by_index, test_json_array_get_bool_by_index)
{
    ...
    cr_assert(json_object_get_bool_by_index(object, 0, &value) ==
              JSON_EXIT_SUCCESS);
    cr_expect(value == true);
    cr_assert(json_object_get_bool_by_index(object, 1, &value) ==
              JSON_EXIT_FAILURE);
...
Test(json_object_get_nb_by_index, test_json_array_get_nb_by_index)
{
    ...
    cr_assert(json_object_append_bool(object, "bool", true) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_nb(object, "nb", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_nb_by_index(object, 0, &value) ==
              JSON_EXIT_FAILURE);
    cr_assert(json_object_get_nb_by_index(object, 1, &value) ==
              JSON_EXIT_SUCCESS);
    cr_expect(value == 34);
    json_object_destroy(object);
}
...
Test(json_object_get_str_by_index, test_json_array_get_str_by_index)
{
    ...
    cr_assert(object != NULL);
    cr_assert(json_object_append_str_dup(object, "str", "value") ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_nb(object, "nb", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_str_by_index(object, 0, &value) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_str_by_index(object, 1, &value) ==
              JSON_EXIT_FAILURE);
...
Test(json_object_get_null_by_index, test_json_array_get_null_by_index)
{
    ...
    cr_assert(json_object_append_nb(object, "nb", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_null_by_index(object, 0, &value) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_null_by_index(object, 1, &value) ==
              JSON_EXIT_FAILURE);
...
Test(json_object_get_object_by_index, test_json_array_get_object_by_index)
{
    ...
    cr_assert(json_object_append_object(object, "obj", sub_object) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_nb(object, "nb", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_object_by_index(object, 0, &value) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_object_by_index(object, 1, &value) ==
              JSON_EXIT_FAILURE);
...
Test(json_object_get_array_by_index, test_json_array_get_array_by_index)
{
    ...
    cr_assert(json_object_append_array(object, "obj", sub_array) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_append_nb(object, "nb", 34) == JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_array_by_index(object, 0, &value) ==
              JSON_EXIT_SUCCESS);
    cr_assert(json_object_get_array_by_index(object, 1, &value) ==
              JSON_EXIT_FAILURE);
