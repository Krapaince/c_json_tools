...
Test(json_array_get_bool_by_index, test_json_array_get_bool_by_index)
{
    ...
    cr_expect(json_array_get_bool_by_index(array, 0, &value) == JSON_ES);
    cr_expect(value == true);
    cr_expect(json_array_get_bool_by_index(array, 1, &value) == JSON_EF);
    cr_expect(json_array_get_bool_by_index(array, 2, &value) == JSON_ES);
...
Test(json_array_get_nb_by_index, test_json_array_get_nb_by_index)
{
    ...
    cr_assert(json_array_append_nb(array, 45) == JSON_ES);
    cr_assert(json_array_append_bool(array, false) == JSON_ES);
    cr_expect(json_array_get_nb_by_index(array, 0, &value) == JSON_EF);
    cr_expect(json_array_get_nb_by_index(array, 1, &value) == JSON_ES);
    cr_expect(value == 45);
    json_array_destroy(array);
}
...
Test(json_array_get_str_by_index, test_json_array_get_str_by_index)
{
    ...
    cr_assert(json_array_append_nb(array, 45) == JSON_ES);
    cr_expect(json_array_get_str_by_index(array, 0, &value) == JSON_ES);
    cr_expect_str_eq(value->value, "toto");
    cr_expect(value->len == 4);
    cr_expect(json_array_get_str_by_index(array, 1, &value) == JSON_EF);
    json_array_destroy(array);
}
...
Test(json_array_get_null_by_index, test_json_array_get_null_by_index)
{
    ...
    cr_expect(json_array_get_null_by_index(array, 0, &value) == JSON_EF);
    cr_expect(json_array_get_null_by_index(array, 1, &value) == JSON_ES);
...
Test(json_array_get_object_by_index, test_json_array_get_object_by_index)
{
    ...
    cr_assert(json_array_append_object(array, object) == JSON_ES);
    cr_assert(json_array_append_nb(array, 45) == JSON_ES);
    cr_expect(json_array_get_object_by_index(array, 0, &value) == JSON_ES);
    cr_expect(json_object_compare(object, value) == true);
    cr_expect(json_array_get_object_by_index(array, 1, &value) == JSON_EF);
    json_array_destroy(array);
}
...
Test(json_array_get_array_by_index, test_json_array_get_array_by_index)
{
    ...
    cr_expect(json_array_get_array_by_index(array, 0, &value) == JSON_EF);
    cr_expect(json_array_get_array_by_index(array, 1, &value) == JSON_ES);
