...
Test(json_parse_array_from_str, test_json_parse_araay_from_array_valid)
{
    ...
    cr_assert(str != NULL);
    array = json_parse_array_from_str(str);
    cr_assert(array != NULL);
    cr_assert(json_errno == JSON_E_DEFAULT);
    cr_assert(json_generate_array_to_file(array,
...
Test(json_parse_array_from_str, test_json_parse_array_from_str_invalid_eof)
{
...
Test(json_parse_array_from_str,
     test_json_parse_array_from_str_invalid_eof_excess)
{
