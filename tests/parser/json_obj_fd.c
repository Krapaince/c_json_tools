...
Test(json_object_parse_from_fd, test_json_parse_obj_from_filepath_valid)
{
    int fd = open("tests/file/obj/valid.json", O_RDONLY);
    json_object_t* obj = json_object_parse_from_fd(fd);
...
Test(json_object_parse_from_fd, test_json_object_parse_from_fd_invalid_eof)
{
