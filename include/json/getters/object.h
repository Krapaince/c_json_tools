...
#ifndef JSON_EXPORT_GETTERS_OBJECT_H_
#define JSON_EXPORT_GETTERS_OBJECT_H_
...
// Gets the element corresponding to the key and the type JSON_BOOL. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the element and the function success.
//
// Return:
//   Failure: JSON_EXIT_FAILURE
//   Success: JSON_EXIT_SUCCESS
...
// isn't any value corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
//   Failure: JSON_EXIT_FAILURE
//   Success: JSON_EXIT_SUCCESS
...
// Gets the element corresponding to the key and the type JSON_NB. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
...
// Gets the element corresponding to the key and the type JSON_NULL. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
...
// Gets the element corresponding to the key and the type JSON_STR. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
...
//   Success: JSON_EXIT_SUCCESS
//
int json_object_get_str_element_by_key(json_object_t const* obj,
                                       char const* key,
                                       json_object_element_t const** ptr);
...
//   Success: JSON_EXIT_SUCCESS
//
int json_object_get_str_value_by_key(json_object_t const* obj, char const* key,
                                     char const** ptr);

// Gets the element corresponding to the key and the type JSON_OBJ. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
...
// Gets the element corresponding to the key and the type JSON_ARRAY. If there
// isn't any element corresponding, ptr is set to null and the function fails.
// Otherwise the ptr is set with the value and the function success.
//
// Return:
...
// The caller should not send a NULL ptr.
//
// Return:
...
#endif /* !JSON_EXPORT_GETTERS_OBJECT_H_ */
